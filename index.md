...
instructor: ["Alexey Akimov", "Johannes Hachmann", "Ignacio Franco", "Alexander Sokolov", "Benjamine Levine", "Arshad Mehmood" ]  # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [ "Layla Heidarizadeh", "Kosar Yasin" ] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
